...
export CONNECT_PRODUCER_SSL_TRUSTSTORE_LOCATION=/ect/kafka/truststore.jks
export CONNECT_PRODUCER_SSL_TRUSTSTORE_PASSWORD=$TRUSTSTORE_PASSWORD
export CONNECT_PRODUCER_SSL_KEYSTORE_LOCATION=/ect/kafka/keystore.jks
...
export CONNECT_CONSUMER_SSL_TRUSTSTORE_LOCATION=/ect/kafka/truststore.jks
export CONNECT_CONSUMER_SSL_TRUSTSTORE_PASSWORD=$TRUSTSTORE_PASSWORD
export CONNECT_CONSUMER_SSL_KEYSTORE_LOCATION=/ect/kafka/keystore.jks
