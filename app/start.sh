...
curl -vvv -X POST http://sfsc-kafka-c1-test.herokuapp.com:$PORT/connectors/salesforce-kafka-snowflakes -H "Content-Type: application/json" --data '{
	...
	"config":{
		...
		"snowflake.url.name":"https://wda05749.snowflakecomputing.com?tracing=ALL:443",
