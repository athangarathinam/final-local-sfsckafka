...
RUN confluent-hub install --no-prompt snowflakeinc/snowflake-kafka-connector:1.5.1 \
 ...
 RUN curl -sSL "https://repo1.maven.org/maven2/org/bouncycastle/bc-fips/1.0.2/bc-fips-1.0.2.jar"" -o /usr/share/java/kafka-connect-jdbc/bc-fips-1.0.2.jar \
  && curl -sSL "https://repo1.maven.org/maven2/org/bouncycastle/bcpkix-fips/1.0.5/bcpkix-fips-1.0.5.jar"" -o /usr/share/java/kafka-connect-jdbc/bcpkix-fips-1.0.5.jar
