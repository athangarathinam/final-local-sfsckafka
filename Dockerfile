...
CMD curl -vvv -X POST -H "Content-Type: application/json" --data /tmp/connect-distributed.properties https://sfsc-kafka-c1-test.herokuapp.com:80:10.101.17.19/connectors
