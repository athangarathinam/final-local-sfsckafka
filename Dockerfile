...
RUN confluent-hub install --no-prompt snowflakeinc/snowflake-kafka-connector:1.3.1 \
...
ENV CONNECT_PLUGIN_PATH="/usr/share/java/kafka-connect-jdbc,/usr/share/confluent-hub-components/snowflakeinc-snowflake-kafka-connector/lib/snowflake-kafka-connector-1.3.1.jar,/usr/share/confluent-hub-components/snowflakeinc-snowflake-kafka-connector/lib/snowflake-jdbc-3.12.12.jar,/etc/kafka-connect"
