...
COPY /usr/share/java/kafka-connect-jdbc/bc-fips-1.0.2.jar /etc/kafka-connect/bc-fips-1.0.2.jar
COPY /usr/share/java/kafka-connect-jdbc/bcpkix-fips-1.0.5.jar /etc/kafka-connect/bcpkix-fips-1.0.5.jar
